  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-black">
      <div className="absolute inset-0 top-2">
        ...
        <img src={Ninth1} alt="background" className="absolute top-170 sm:top-90 md:top-100 lg:top-110 left-45 -translate-x-1/2 -translate-y-1/2 w-70 sm:w-60 md:w-74 lg:w-80 object-contain"/>
